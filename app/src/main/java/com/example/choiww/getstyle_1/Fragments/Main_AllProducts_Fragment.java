...
//                staggeredGridLayoutManager = new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL);
                ...
                // 아이탬 별 구분선 수직 수평 모두 넣기
                newProductRecyclerview_frag.addItemDecoration(new DividerItemDecoration(mcontext,DividerItemDecoration.VERTICAL));
                newProductRecyclerview_frag.addItemDecoration(new DividerItemDecoration(mcontext,DividerItemDecoration.HORIZONTAL));
//                DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(mcontext, new GridLayoutManager().getOrientation());
                //
                /**test **/
